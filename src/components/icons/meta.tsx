export default function Meta({ size = 16 }: { size?: number }) {
  return (
    <svg
    ...
    >
      <g transform="translate(1.4065934065934016 1.4065934065934016) scale(2.81 2.81)">
        ...
        <path
          d="M 25.774 24.885 c -3.84 0 -7.101 2.695 -9.831 6.817 c -3.859 5.825 -6.222 14.5 -6.222 22.832 c 0 3.437 0.754 6.075 1.74 7.671 l -8.288 5.458 C 1.045 64.123 0 59.478 0 54.186 c 0 -9.624 2.642 -19.655 7.665 -27.401 c 4.457 -6.87 10.889 -11.674 18.265 -11.674 L 25.774 24.885 z"
          transform=" matrix(1 0 0 1 0 0) "
          strokeLinecap="round"
        />
      </g>
